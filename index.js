...
const token = "NzM2NTk0Njc2NTE3NDM3NTcx.XxxFQA.WwoTIxnjhLjHgamzcQGMlzfj39k";
...
client.on('message', (message) => {
  ...
  if(message.content == '!si') {
    let embed = new Discord.RichEmbed()
    let img = 'https://cdn.discordapp.com/app-icons/736594676517437571/bc8b347820b82010832f81743db5b099.png?size=64';
    var duration = moment.duration(client.uptime).format(" D [일], H [시간], m [분], s [초]");
    embed.setColor('#186de6')
    embed.setAuthor('server info of 코코 BOT', img)
    embed.setFooter(`코코 BOT ❤️`)
    embed.addBlankField()
